...
namespace Mpeg4Lib.Boxes
{
	public class StszBox : FullBox
	{
		...
		public static StszBox CreateBlank(Box parent)
		{
		...
		public StszBox(Stream file, BoxHeader header, Box parent) : base(file, header, parent)
		{
			...
			if (SampleCount > int.MaxValue)
				throw new NotSupportedException($"Mpeg4Lib does not support MPEG-4 files with more than {int.MaxValue} samples (frames)");
