...
{
	internal sealed unsafe class FaadAacDecoder : AacDecoder
	{
		private readonly FaadHandle Handle;
		...
		{
			private const string libPath = "libfaad2_dll.dll";
			...
			{
				/* Audio Specific Info */
				private readonly byte objectTypeIndex;
				private readonly byte samplingFrequencyIndex;
				private readonly uint samplingFrequency;
				private readonly byte channelsConfiguration;

				/* GA Specific Info */
				private readonly byte frameLengthFlag;
				private readonly byte dependsOnCoreCoder;
				private readonly ushort coreCoderDelay;
				private readonly byte extensionFlag;
				private readonly byte aacSectionDataResilienceFlag;
				private readonly byte aacScalefactorDataResilienceFlag;
				private readonly byte aacSpectralDataResilienceFlag;
				private readonly byte epConfig;
				private readonly sbyte sbr_present_flag;
				private readonly sbyte forceUpSampling;
				private readonly sbyte downSampledSBR;
			}
